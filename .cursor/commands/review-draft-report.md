...
- Each feedback: `stage` (one free-text qualitative line) + `body` (multi-paragraph prose)
- `reviewRound: 1`
...
- Six feedback cards with reflective prose, not task items
- Title section: clarity/strength suggestions only; preserve voice and ideas
- Stage line: qualitative snapshot including positives when deserved
