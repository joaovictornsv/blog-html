...
## 4. Inputs (what I should provide)

When possible, I will send:
...
**Scope:** This workflow is for **long-form pieces** (full blog posts, essays). Always deliver the full report (§5). No shortened template.
...
### 5.3 Other perspectives (required)

**Goals:** Strengthen intellectual honesty and depth without forcing both-sides-ism.

For each relevant claim or strong opinion:
...
- Places I sound like I own the truth when I mean to share experience  
- Topics where a single anecdote may not generalize  
- Missing context that could make me seem dismissive of other valid paths  

Do **not** argue that my view is wrong; help me present it more fairly and powerfully.

---

### 5.4 Clarity analysis (required)
...
### 5.5 Text organization and logic (required)

**Goals:** Ideas flow forward; arguments hold together; no hidden gaps.
...
Tag suggestions when helpful:

| Label | Meaning |
|-------|---------|
| **Critical** | Likely to confuse, offend unfairly, or break logic/credibility |
| **Recommended** | Clear improvement with low risk to my voice |
| **Optional** | Polish, alternative phrasing, taste |
...
## 10. Prompt template (copy when requesting a review)
